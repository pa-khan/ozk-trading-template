...
<div class="result__elem">
	<div class="result__elem-title h3"><h3><?$APPLICATION->IncludeComponent(
					...
					Array(
						...
						"EDIT_TEMPLATE" => "",
						"PATH" => "/inc/t2-result__elem-title-1.php"
					)
				);?></h3>  <span>on <?= $currentDate; ?></span></div>
	<form class="result__elem-datepicker datepicker" id="auc-price-form">
		<div class="datepicker__input input --date --start">
			<div class="input__wrap">
				<input class="input__area" type="text" name="date_price_start" value="<?= $arParams["YEAR"]; ?>" placeholder="Selection" readonly="" id="auc-price-input">
			</div>
		</div>
