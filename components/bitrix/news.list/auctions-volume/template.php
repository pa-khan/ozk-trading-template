...
<div class="result__elem">
	<div class="result__elem-title h3"><h3><?$APPLICATION->IncludeComponent(
					...
					Array(
						...
						"EDIT_TEMPLATE" => "",
						"PATH" => "/inc/".SITE_ID."-result__elem-title-2.php"
					)
				);?></h3></div>
	<form class="result__elem-datepicker datepicker" id="auc-volume-form">
		<div class="datepicker__input input --date --start">
			<div class="input__wrap">
				<input class="input__area" type="text" name="date_price_start" value="<?= $arParams["FROM"]; ?>" placeholder="С" readonly="" id="auc-volume-input-from">
			</div>
		</div>
		<div class="datepicker__input input --date --end">
			<div class="input__wrap">
				<input class="input__area" type="text" value="<?= $arParams["TO"]; ?>" name="date_volume_end" placeholder="По" readonly="" id="auc-volume-input-to">
			</div>
		</div>
			...
			<div class="result__elem-info">
				<div class="result__elem-name"><?$APPLICATION->IncludeComponent(
					...
					Array(
						...
						"AREA_FILE_SUFFIX" => "inc",
						"EDIT_TEMPLATE" => "",
						"PATH" => "/inc/".SITE_ID."-result-zd-t.php"
					)
				);?></div>
			...
			<div class="result__elem-info">
				<div class="result__elem-name"><?$APPLICATION->IncludeComponent(
					...
					Array(
						...
						"AREA_FILE_SUFFIX" => "inc",
						"EDIT_TEMPLATE" => "",
						"PATH" => "/inc/".SITE_ID."-result-auto-t.php"
					)
				);?></div>
				<div class="result__elem-value">
					<? if ($arParams['FROM'] || $arParams['TO']) { ?>
		...
		<div class="result__elem-item">
			<div class="result__elem-desc"><?$APPLICATION->IncludeComponent(
					...
					Array(
						...
						"AREA_FILE_SUFFIX" => "inc",
						"EDIT_TEMPLATE" => "",
						"PATH" => "/inc/".SITE_ID."-result-all-t.php"
					)
				);?></div>
